...
async function getScripts(){ //get the main script and the new overlay from github and load them into vars
  rdScript = await getScript("https://raw.githubusercontent.com/blueiswall/blueclient/main/index.js");
...
try {
 ...
 rdTheme = await getScript('https://raw.githubusercontent.com/blueiswall/blueclient/main/main.css');
rdTheme1 = await getScript('https://raw.githubusercontent.com/blueiswall/blueclient/main/main.css');  
}
} catch(err) {
  console.error(err)
